...
LastEditTime: 2024-05-18 16:04:13
LastEditors: Van Sun
Description: back testing with Backtrader
FilePath: \IFactor\Bt_sqm.py
...
#取股价
begin = datetime.datetime(2024, 3, 25)#Backtest from 2010-01-01
# begin = datetime.datetime(2023, 12, 10)#Backtest from 2010-01-01
end = datetime.datetime(2024, 4, 23)#Backtest end 2024-04-24
...
# aa=get_all_rebalance_days(1,begin,end)
# 按股票代码，依次循环传入数据
...
daily_return.to_csv('dailyReturnSQM.csv')
# 打印评价指标
# print("--------------- AnnualReturn -----------------")
